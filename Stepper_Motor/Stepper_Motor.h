...
private:                                                                    // закрытые методы
    ...
    bool _direction;                                                        // переменная направления вращения
    float _ratio;                                                           // переменная передаточного отношения
    float _pitch;                                                           // переменная шага резьбы винта
    uint16_t _lenght;                                                       // переменная длины направляющей (мм)
